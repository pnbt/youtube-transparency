   ...
   function appendVideo(key) {
      ...
      jsonLocal[key]
         ...
         .forEach((item, index) => {
            ...
            <div class="mult" data-balloon-length="large" data-balloon="À partir du candidat sélectioné, cette video a été suggérée par YouTube ${Math.round(item.mult * 10)/10} fois plus que la moyenne des autres vidéos suggérées."><div class="mult-x">${Math.round(item.mult * 10)/10}x </div>
