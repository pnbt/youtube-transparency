...
$(document).ready(function() {
   ...
   const lastDate = 'ytrecos-election-sweden-2018-09-09';
   $.get('/data/themessweden.json', function(data) {
   ...
   $.get('/data/sweden/' + url + '.json', function(data) {
    // console.log(data);
      jsonLocal = data;
      let count = 0;
   ...
   $(document).on('change', '#video-select', function(event) {
      $.get(
      '/data/sweden/' + event.target.value + '.json',
      (data) => {
